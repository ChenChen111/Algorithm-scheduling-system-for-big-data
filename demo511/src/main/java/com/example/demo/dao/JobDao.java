...
public interface JobDao {
    ...
    public List<Job> selectById(String job_id);
    ...
    public void updateStartTimeByJob(Job job);

    @Update("update job_info set end_time = #{end_time} where job_id=#{job_id}")
    public void updateEndTimeByJob(Job job);
    ...
    @Update("update job_info set exe_times = exe_times + 1 where job_id=#{job_id}")
